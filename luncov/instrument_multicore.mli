...
val get_label_ids : unit -> int list
...
module KFSet : (Set.S with type elt = Cil_types.kernel_function)

val get_kf_lbl_partition : unit -> KFSet.t * (string , id) Hashtbl.t
...
val create_project : unit -> Project.t
val add_annotations_get_ips : id list -> (id , (Property.t option)) Hashtbl.t
val add_annotation_get_ip : id -> Property.t option
