/* run.config
   EXECNOW: LOG @PTEST_NAME@.labels LOG @PTEST_NAME@.log @frama-c@ -luncov-vwap @PTEST_DIR@/@PTEST_NAME@.c -luncov-labels @PTEST_DIR@/result/@PTEST_NAME@.labels -wp-msg-key no-time-info > @PTEST_DIR@/result/@PTEST_NAME@.log 
 */
